...
- 检查版本并更新常见的全局包。
- 在一个界面中管理 Codex、Claude Code、Cursor、Gemini CLI、Aider、Continue、Kiro、iFlow、OpenCode、GitHub Copilot CLI、Qwen Code、Cline、Amp、Crush、Amazon Q Developer CLI 等 AI CLI 工具。
